...
class SuperpoweredWebAudio {
    constructor(minimumSamplerate, superpowered, offlineRenderingOptions = false) { 
        ...
        let c = offlineRenderingOptions ? new window.OfflineAudioContext({
            numberOfChannels: 2,
            length: offlineRenderingOptions.length,
