class SuperpoweredTrackLoader {
  constructor(receiver) {
    ...
    if (typeof receiver.terminate !== "undefined")
      receiver.addEventListener("message", this.onmessage); // Worker
  }
  ...
  load(url) {
    let trackLoaderWorker = new Worker(
      "static/superpowered/SuperpoweredTrackLoaderWorker.js"
    );
  ...
  transfer(arrayBuffer, trackLoaderWorker) {
    if (typeof this.receiver.postMessage === "function")
  ...
  static downloadAndDecode(url, obj) {
    if (
      ...
      obj.sendMessageToMainScope({ SuperpoweredLoad: url });
    else new SuperpoweredTrackLoader(obj).load(url);
  }
}

if (typeof exports === "object" && typeof module === "object")
  module.exports = { SuperpoweredTrackLoader };
