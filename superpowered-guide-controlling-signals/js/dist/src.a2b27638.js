...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"src/superpowered/SuperpoweredGlueModule.js":[function(require,module,exports) {
var define;
"use strict";
...
exports.SuperpoweredGlue = void 0;
...
var SuperpoweredGlue = /*#__PURE__*/function () {
  function SuperpoweredGlue() {
    _classCallCheck(this, SuperpoweredGlue);
    ...
    this.Uint8Buffer = /*#__PURE__*/function () {
    ...
    this.Int8Buffer = /*#__PURE__*/function () {
      function _class2(length) {
    ...
    this.Uint16Buffer = /*#__PURE__*/function () {
      function _class3(length) {
    ...
    this.Int16Buffer = /*#__PURE__*/function () {
      function _class4(length) {
    ...
    this.Uint32Buffer = /*#__PURE__*/function () {
      function _class5(length) {
    ...
    this.Int32Buffer = /*#__PURE__*/function () {
      function _class6(length) {
    ...
    this.BigUint64Buffer = /*#__PURE__*/function () {
      function _class7(length) {
    ...
    this.BigInt64Buffer = /*#__PURE__*/function () {
      function _class8(length) {
    ...
    this.Float32Buffer = /*#__PURE__*/function () {
      function _class9(length) {
    ...
    this.Float64Buffer = /*#__PURE__*/function () {
      function _class10(length) {
  ...
  _createClass(SuperpoweredGlue, [{
    ...
    key: "createViewFromType",
    value: function createViewFromType(type, pointer, length) {
      var buffer = {
        pointer: pointer,
        length: length,
    ...
    key: "returnPointerToView",
    value: function returnPointerToView(r, type) {
      if (type > 0 && _typeof(r) !== undefined) {
        var length = this.__functions__.__lastarraylength__();
    ...
    value: function invokeMethod() {
      ...
      for (var _index = arguments.length - 1; _index > 0; _index--) {
        if (arguments[_index].array != undefined) arguments[_index] = arguments[_index].array.byteOffset;else if (typeof arguments[_index] == 'string') {
          arguments[_index] = this.__glue__.toWASMString(arguments[_index]);
          strings.push(arguments[_index]);
        }
      }

      var info = arguments[0];
      arguments[0] = this.__pointer__;
      var r = info.function.apply(this, arguments);

      for (var _i = 0, _strings = strings; _i < _strings.length; _i++) {
        var string = _strings[_i];

        this.__glue__.free(string);
      }
    ...
    value: function invokeFunction() {
      ...
      for (var _index2 = arguments.length - 1; _index2 >= 0; _index2--) {
        if (arguments[_index2].array != undefined) arguments[_index2] = arguments[_index2].array.byteOffset;else if (typeof arguments[_index2] == 'string') {
          arguments[_index2] = this.glue.toWASMString(arguments[_index2]);
          strings.push(arguments[_index2]);
        }
      }

      var r = this.apply(this, arguments);

      for (var _i2 = 0, _strings2 = strings; _i2 < _strings2.length; _i2++) {
        var string = _strings2[_i2];
        this.glue.free(string);
      }
    ...
    key: "invokeExportedFunction",
    value: function invokeExportedFunction() {
      var r = this.apply(this, arguments);
      if (_typeof(r.array) !== undefined) r = r.array.byteOffset;
      return r;
    }
  }, {
    key: "createClass",
    value: function createClass(classnamePointer, classnameLen, sizeofClass) {
      var glue = this;
      var classname = glue.toString(classnamePointer, classnameLen);

      var WASM = /*#__PURE__*/function () {
        function WASM() {
          _classCallCheck(this, WASM);

          var meta = Object.getPrototypeOf(this).constructor.__meta__;
          ...
          var _iterator = _createForOfIteratorHelper(meta.properties),
              _step;
          ...
          var _iterator2 = _createForOfIteratorHelper(meta.methods),
              _step2;

          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var method = _step2.value;
              this[method.name] = glue.invokeMethod.bind(this, {
    ...
    key: "createDestructor",
    value: function createDestructor() {
      this.__classUnderConstruction__.__meta__.hasDestructor = this.__classUnderConstruction__.__meta__.hasConstructor;
    }
  }, {
    key: "createClassConstant",
    value: function createClassConstant(nameptr, namelen, value) {
      var name = this.toString(nameptr, namelen);
      this.__classUnderConstruction__[name] = value;
    }
  }, {
    key: "createConstant",
    value: function createConstant(nameptr, namelen, value) {
      var name = this.toString(nameptr, namelen);
      this[name] = value;
    }
  }, {
    key: "createPropertyFromDescriptor",
    value: function createPropertyFromDescriptor(object, descriptor) {
      var buffer = this.createViewFromType(descriptor.viewType, object.__pointer__ + descriptor.offset, descriptor.viewLength);
    ...
    key: "createProperty",
    value: function createProperty(propertynamePointer, propertynameLen, offset, viewType, viewLength) {
      var propertyname = this.toString(propertynamePointer, propertynameLen);
      var descriptor = {
        name: propertyname,
        offset: offset,
        viewType: viewType,
    ...
    key: "createStaticPropertyFromDescriptor",
    value: function createStaticPropertyFromDescriptor(wasmClass, descriptor) {
      var buffer = this.createViewFromType(descriptor.viewType, descriptor.pointer, descriptor.viewLength);
    ...
    key: "createStaticProperty",
    value: function createStaticProperty(propertynamePointer, propertynameLen, pointer, viewType, viewLength) {
      var propertyname = this.toString(propertynamePointer, propertynameLen);
      var descriptor = {
        name: propertyname,
        pointer: pointer,
    ...
    key: "createMethod",
    value: function createMethod(methodnamePointer, methodnameLen, returnPointerType) {
      var methodname = this.toString(methodnamePointer, methodnameLen);
      var wasmMethodname = this.__classUnderConstruction__.__meta__.name + '::' + methodname;

      this.__classUnderConstruction__.__meta__.methods.push({
        name: methodname,
        wasmFunction: wasmMethodname,
        returnPointerType: returnPointerType
      });
    }
  }, {
    key: "createStaticMethod",
    value: function createStaticMethod(methodnamePointer, methodnameLen, returnPointerType) {
      var methodname = this.toString(methodnamePointer, methodnameLen);
      var wasmMethodname = this.__classUnderConstruction__.__meta__.name + '::' + methodname;
    ...
    key: "createFunction",
    value: function createFunction(methodnamePointer, methodnameLen, returnPointerType) {
      var methodname = this.toString(methodnamePointer, methodnameLen);

      if (!this[methodname]) {
        // maybe this function is in a namespace
        for (var namespace in this.__functionsWithNamespace__) {
    ...
    key: "exportToWasm",
    value: function exportToWasm(functionName, f) {
      this.__exportsToWasm__[functionName] = this.invokeExportedFunction.bind(f);
    }
  }, {
    key: "onMemoryGrowth",
    value: function onMemoryGrowth(n) {
    ...
    key: "consolelog",
    value: function consolelog(pointer, strlen) {
      console.log(this.toString(pointer, strlen));
    }
  }, {
    key: "loadFromArrayBuffer",
    value: function () {
      var _loadFromArrayBuffer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(wasmCode) {
        var _this = this;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                afterWASMLoaded = _args.length > 1 && _args[1] !== undefined ? _args[1] : null;
                ...
                return WebAssembly.instantiate(wasmCode, {
                  ...
                  var outputBuffer = _this.__functions__.__malloc__(1024);

                  var stringview = new Uint8Array(_this.linearMemory, _this.__functions__.__malloc__(1024), 1024);

                  for (var f in _this.__functions__) {
                    if (f != '__demangle__') {
                      var length = _this.__functions__.__demangle__(_this.toWASMString(f, stringview), outputBuffer);

                      if (length > 0) {
                        var name = _this.toString(outputBuffer, length);

                        var par = name.indexOf('(');
                        if (par > 0) name = name.substring(0, par);
                        var namespace = name.lastIndexOf('::');
      ...
      function loadFromArrayBuffer(_x2) {
        return _loadFromArrayBuffer.apply(this, arguments);
      }
    ...
    key: "toString",
    value: function toString(pointer) {
      var strlen = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      var view = null;

      if (strlen < 1) {
        var viewLength = this.linearMemory.byteLength - pointer;
    ...
    key: "toWASMString",
    value: function toWASMString(str) {
    ...
    key: "malloc",
    value: function malloc(bytes) {
      var pointer = this.__functions__.__malloc__(bytes);

      if (this.__memorygrowview__.buffer.byteLength < 1) this.updateMemoryViews();
      return pointer;
    }
  }, {
    key: "updateMemoryViews",
    value: function updateMemoryViews() {
      var _iterator3 = _createForOfIteratorHelper(this.__views__),
          _step3;
    ...
    key: "free",
    value: function free(pointer) {
      this.__functions__.__free__(pointer);
    }
  }, {
    key: "setInt64",
    value: function setInt64(pointer, index, value) {
      this.__functions__.__setint64__(pointer, index, value);
    }
  }, {
    key: "bufferToWASM",
    value: function bufferToWASM(buffer, input) {
      var inBufferL = null;
      var inBufferR = null;
      ...
      for (var n = 0, i = 0; n < buffer.array.length; n++, i++) {
    ...
    key: "bufferToJS",
    value: function bufferToJS(buffer, output) {
      var outBufferL = null;
      var outBufferR = null;
    ...
    key: "arrayBufferToWASM",
    value: function arrayBufferToWASM(arrayBuffer) {
      var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      var pointer = this.malloc(arrayBuffer.byteLength + offset);
      new Uint8Array(this.linearMemory).set(new Uint8Array(arrayBuffer, 0, arrayBuffer.byteLength), pointer + offset);
      return pointer;
    }
  }, {
    key: "copyWASMToArrayBuffer",
    value: function copyWASMToArrayBuffer(pointer, lengthBytes) {
      var arrayBuffer = new ArrayBuffer(lengthBytes);
      new Uint8Array(arrayBuffer, 0, lengthBytes).set(new Uint8Array(this.linearMemory, pointer, lengthBytes));
      return arrayBuffer;
    }
  }, {
    key: "moveWASMToArrayBuffer",
    value: function moveWASMToArrayBuffer(pointer, lengthBytes) {
      var arrayBuffer = this.copyWASMToArrayBuffer(pointer, lengthBytes);
      this.free(pointer);
      return arrayBuffer;
    }
  }], [{
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                obj = new SuperpoweredGlue();
                _context2.next = 3;
                return fetch(url).then(function (response) {
                  return response.arrayBuffer();
                }).then(function (bytes) {
                  return obj.loadFromArrayBuffer(bytes);
                });
  ...
  return SuperpoweredGlue;
}();

exports.SuperpoweredGlue = SuperpoweredGlue;
if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = SuperpoweredGlue;else if (typeof define === 'function' && define['amd']) define([], function () {
  return SuperpoweredGlue;
});else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["SuperpoweredGlue"] = SuperpoweredGlue;
},{}],"src/superpowered/SuperpoweredTrackLoaderModule.js":[function(require,module,exports) {
var define;
"use strict";
...
exports.SuperpoweredTrackLoader = void 0;
...
var SuperpoweredTrackLoader = /*#__PURE__*/function () {
  function SuperpoweredTrackLoader(receiver) {
    _classCallCheck(this, SuperpoweredTrackLoader);
  ...
  _createClass(SuperpoweredTrackLoader, [{
    key: "onmessage",
    ...
    value: function load(url) {
      var trackLoaderWorker = new Worker("/SuperpoweredTrackLoaderWorker.cc407fd3.js");
      ...
      trackLoaderWorker.postMessage({
        load: trackLoaderWorker.__url__
      });
    }
  }, {
    key: "transfer",
    value: function transfer(arrayBuffer, trackLoaderWorker) {
      if (typeof this.receiver.postMessage === 'function') this.receiver.postMessage({
        SuperpoweredLoaded: {
          buffer: arrayBuffer,
          url: trackLoaderWorker.__url__
        }
      }, [arrayBuffer]);else this.receiver({
        SuperpoweredLoaded: {
          buffer: arrayBuffer,
          url: trackLoaderWorker.__url__
        }
    ...
    key: "downloadAndDecode",
    value: function downloadAndDecode(url, obj) {
  ...
  return SuperpoweredTrackLoader;
}();

exports.SuperpoweredTrackLoader = SuperpoweredTrackLoader;
if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = {
  SuperpoweredTrackLoader: SuperpoweredTrackLoader
};else if (typeof define === 'function' && define['amd']) define([], function () {
  return {
    SuperpoweredTrackLoader: SuperpoweredTrackLoader
  };
});else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["SuperpoweredTrackLoader"] = {
  SuperpoweredTrackLoader: SuperpoweredTrackLoader
};
},{"./SuperpoweredTrackLoaderWorker.js":[["SuperpoweredTrackLoaderWorker.cc407fd3.js","src/superpowered/SuperpoweredTrackLoaderWorker.js"],"SuperpoweredTrackLoaderWorker.cc407fd3.js.map","src/superpowered/SuperpoweredTrackLoaderWorker.js"]}],"src/superpowered/SuperpoweredWebAudio.js":[function(require,module,exports) {
var define;
"use strict";
...
Object.defineProperty(exports, "SuperpoweredGlue", {
  enumerable: true,
  get: function () {
    return _SuperpoweredGlueModule.default;
  }
});
Object.defineProperty(exports, "SuperpoweredTrackLoader", {
  enumerable: true,
  get: function () {
    return _SuperpoweredTrackLoaderModule.SuperpoweredTrackLoader;
  }
});
exports.SuperpoweredWebAudio = void 0;

var _SuperpoweredGlueModule = _interopRequireDefault(require("./SuperpoweredGlueModule.js"));

var _SuperpoweredTrackLoaderModule = require("./SuperpoweredTrackLoaderModule.js");
...
var SuperpoweredWebAudio = /*#__PURE__*/function () {
  function SuperpoweredWebAudio(minimumSamplerate, superpowered) {
    _classCallCheck(this, SuperpoweredWebAudio);
  ...
  _createClass(SuperpoweredWebAudio, [{
    key: "getUserMediaForAudio",
    value: function getUserMediaForAudio(constraints, onPermissionGranted, onPermissionDenied) {
    ...
    key: "getUserMediaForAudioAsync",
    value: function () {
      var _getUserMediaForAudioAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(constraints) {
        var _this = this;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", new Promise(function (resolve, reject) {
                  _this.getUserMediaForAudio(constraints, function (stream) {
                    if (navigator.fastAndTransparentAudio) {
      ...
      function getUserMediaForAudioAsync(_x) {
        return _getUserMediaForAudioAsync.apply(this, arguments);
      }

      return getUserMediaForAudioAsync;
    }()
  }, {
    key: "createAudioNodeAsync",
    value: function () {
      var _createAudioNodeAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url, className, onMessageFromAudioScope) {
        var _this2 = this;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  _this2.createAudioNode(url, className, resolve, onMessageFromAudioScope);
                }));
      ...
      function createAudioNodeAsync(_x2, _x3, _x4) {
        return _createAudioNodeAsync.apply(this, arguments);
      }

      return createAudioNodeAsync;
    }()
  }, {
    key: "createAudioNode",
    value: function createAudioNode(url, className, callback, onMessageFromAudioScope) {
      var _this3 = this;

      if (!AudioWorkletHasBrokenModuleImplementation && typeof AudioWorkletNode === 'function') {
        this.audioContext.audioWorklet.addModule(url).then(function () {
          var SuperpoweredNode = /*#__PURE__*/function (_AudioWorkletNode) {
            _inherits(SuperpoweredNode, _AudioWorkletNode);

            var _super = _createSuper(SuperpoweredNode);

            function SuperpoweredNode(glue, name) {
              _classCallCheck(this, SuperpoweredNode);

              return _super.call(this, glue.audioContext, name, {
                'processorOptions': {
            ...
            _createClass(SuperpoweredNode, [{
              key: "sendMessageToAudioScope",
              value: function sendMessageToAudioScope(message) {
                var transfer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
                this.port.postMessage(message, transfer);
              }
            }]);

            return SuperpoweredNode;
          }( /*#__PURE__*/_wrapNativeSuper(AudioWorkletNode));

          var node = new SuperpoweredNode(_this3, className);
          node.loader = new _SuperpoweredTrackLoaderModule.SuperpoweredTrackLoader(node);
          ...
          node.port.onmessage = function (event) {
            ...
            if (event.data == '___superpowered___onready___') node.onReadyCallback(node);else node.onMessageFromAudioScope(event.data);
          }.bind(node);
        });
      } else {
        import(url).then(function (processorModule) {
          var node = _this3.audioContext.createScriptProcessor(1024, 2, 2);

          node.samplerate = _this3.audioContext.sampleRate;
          node.inputBuffer = _this3.Superpowered.createFloatArray(1024 * 2);
          node.outputBuffer = _this3.Superpowered.createFloatArray(1024 * 2);
          node.processor = new processorModule.default(_this3.Superpowered, onMessageFromAudioScope, node.samplerate);

          node.sendMessageToAudioScope = function (message) {
            var transfer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
...
if (!AudioWorkletHasBrokenModuleImplementation && typeof AudioWorkletProcessor === 'function') {
  var SuperpoweredAudioWorkletProcessor = /*#__PURE__*/function (_AudioWorkletProcesso) {
    _inherits(SuperpoweredAudioWorkletProcessor, _AudioWorkletProcesso);

    var _super2 = _createSuper(SuperpoweredAudioWorkletProcessor);

    function SuperpoweredAudioWorkletProcessor(options) {
      var _this4;

      _classCallCheck(this, SuperpoweredAudioWorkletProcessor);

      _this4 = _super2.call(this);
      _SuperpoweredGlueModule.default.__uint_max__sp__ = options.processorOptions.maxChannels;

      _this4.port.onmessage = function (event) {
        _this4.onMessageFromMainScope(event.data);
      };

      _this4.ok = false;
      _this4.samplerate = options.processorOptions.samplerate;
      _this4.Superpowered = new _SuperpoweredGlueModule.default();

      _this4.Superpowered.loadFromArrayBuffer(options.processorOptions.wasmCode, _assertThisInitialized(_this4));

      return _this4;
    }

    _createClass(SuperpoweredAudioWorkletProcessor, [{
      key: "afterWASMLoaded",
      value: function afterWASMLoaded() {
      ...
      key: "onMessageFromMainScope",
      value: function onMessageFromMainScope(message) {}
    }, {
      key: "sendMessageToMainScope",
      value: function sendMessageToMainScope(message) {
        this.port.postMessage(message);
      }
    }, {
      key: "processAudio",
      value: function processAudio(buffer, parameters) {}
    }, {
      key: "process",
    ...
    return SuperpoweredAudioWorkletProcessor;
  ...
  var _SuperpoweredAudioWorkletProcessor = /*#__PURE__*/function () {
    function _SuperpoweredAudioWorkletProcessor(sp, oma, sr) {
      _classCallCheck(this, _SuperpoweredAudioWorkletProcessor);

      _defineProperty(this, "onMessageFromAudioScope", null);

      this.loader = new _SuperpoweredTrackLoaderModule.SuperpoweredTrackLoader(this);
    ...
    _createClass(_SuperpoweredAudioWorkletProcessor, [{
      key: "onReady",
      value: function onReady() {}
    }, {
      key: "onMessageFromMainScope",
    ...
    return _SuperpoweredAudioWorkletProcessor;
  }();

  SuperpoweredWebAudio.AudioWorkletProcessor = _SuperpoweredAudioWorkletProcessor;
}

if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = {
  SuperpoweredGlue: _SuperpoweredGlueModule.default,
  SuperpoweredWebAudio: SuperpoweredWebAudio,
  SuperpoweredTrackLoader: _SuperpoweredTrackLoaderModule.SuperpoweredTrackLoader
};else if (typeof define === 'function' && define['amd']) define([], function () {
  return {
    SuperpoweredGlue: _SuperpoweredGlueModule.default,
    SuperpoweredWebAudio: SuperpoweredWebAudio,
...
});else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["SuperpoweredModule"] = {
  SuperpoweredGlue: _SuperpoweredGlueModule.default,
  SuperpoweredWebAudio: SuperpoweredWebAudio,
  SuperpoweredTrackLoader: _SuperpoweredTrackLoaderModule.SuperpoweredTrackLoader
};
},{"./SuperpoweredGlueModule.js":"src/superpowered/SuperpoweredGlueModule.js","./SuperpoweredTrackLoaderModule.js":"src/superpowered/SuperpoweredTrackLoaderModule.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

var _babelPolyfill = _interopRequireDefault(require("babel-polyfill"));

var _SuperpoweredWebAudio = require("./superpowered/SuperpoweredWebAudio");
...
var superPoweredWasmLocation = "http://localhost:1234/superpowered/superpowered.wasm"; // The  location of the processor from the browser to fetch

var controllingSignalsProcessorUrl = "http://localhost:1234/static/processors/controllingSignalsProcessor.js"; // The sample rate we'd like our AudioContext to operate at

var minimumSampleRate = 48000;

var DemoApplication = /*#__PURE__*/function () {
  function DemoApplication() {
    var _this = this;

    _classCallCheck(this, DemoApplication);

    _defineProperty(this, "onMessageProcessorAudioScope", function (message) {
    ...
    _defineProperty(this, "onParamChange", function (id, value) {
      document.getElementById(id).innerHTML = value; // Here we send the new Reverb Size value over to the audio thread to be applied

      _this.processorNode.sendMessageToAudioScope({
  ...
  _createClass(DemoApplication, [{
    key: "boot",
    value: function () {
      var _boot = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.setupSuperpowered();
    ...
    key: "setupSuperpowered",
    value: function () {
      var _setupSuperpowered = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                console.log();
                _context2.next = 3;
                return _SuperpoweredWebAudio.SuperpoweredGlue.fetch(superPoweredWasmLocation);

              case 3:
                this.superpowered = _context2.sent;
                this.superpowered.Initialize({
                ...
                this.webaudioManager = new _SuperpoweredWebAudio.SuperpoweredWebAudio(minimumSampleRate, this.superpowered);
      ...
      function setupSuperpowered() {
        return _setupSuperpowered.apply(this, arguments);
      }

      return setupSuperpowered;
    }()
  }, {
    key: "loadProcessor",
    value: function () {
      var _loadProcessor = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return this.webaudioManager.createAudioNodeAsync(controllingSignalsProcessorUrl, "ControllingSignalsProcessor", this.onMessageProcessorAudioScope);

              case 2:
                this.processorNode = _context3.sent;
    ...
    value: function resumeContext() {
      console.log("resuming"); //hide the start button

      document.getElementById("startButton").style.display = "none"; //unhide the controls
...
var demoApp = new DemoApplication(); // expose a function to the window so we can call it from the HTML markup

window.resumeContext = demoApp.resumeContext.bind(demoApp);
window.onParamChange = demoApp.onParamChange.bind(demoApp);
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./superpowered/SuperpoweredWebAudio":"src/superpowered/SuperpoweredWebAudio.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
